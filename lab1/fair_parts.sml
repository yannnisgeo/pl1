...
let
	...
	let
		...
		let
			...
			|   element((r::rs), Nrem, current, currentList, Mrem) =  if Nrem=Mrem then element(rs, Nrem-1, r, (LargeInt.toString(r)::("|"::currentList)), Mrem-1) else
																if current+r>w then element(rs, Nrem-1, r, (LargeInt.toString(r)::("|"::currentList)), Mrem-1) 
																else element(rs, Nrem, current+r, (LargeInt.toString(r)::currentList), Mrem-1)
